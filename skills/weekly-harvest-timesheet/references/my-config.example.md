...
Optional — paste your monthly forecast table here if you have one. The skill uses this as a GUIDE for filling non-meeting hours with project work.
...
Calendar events you're invited to but don't actually attend:
...
Calendar events that aren't work meetings:
